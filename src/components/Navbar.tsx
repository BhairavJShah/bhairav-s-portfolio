...
const Navbar = ({ theme, toggleTheme, onViewChange }: NavbarProps) => {
  ...
  const handleNavClick = (id: string) => {
    // Always go back to home view when a section is clicked
    onViewChange('home');

    // Wait for the view to switch back to home before scrolling
    setTimeout(() => {
      const element = document.getElementById(id);
      if (element) {
